...
// Wind unit: 0 = km/h (default), 1 = mph, 2 = m/s. Values arriving from the
// phone are already converted to this unit - the watch never converts.
static int s_wind_unit = 0;
static const char *WIND_UNIT_SUFFIX[3] = {"km/h", "mph", "m/s"};
