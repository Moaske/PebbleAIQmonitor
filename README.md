...
## Features
- Main screen with current PM2.5, PM10, NO2, Ozone (O3) polutant values as wel as Temperature and UV Index at the current location (shown on top) and at the bottom the general European Air Quality Index
