...
## Features
- Main screen with PM2.5, PM10, NO2, Ozone polutant values as wel as Temperature and UV Index at the current locationm (shown on top) and at the bottom the general European Air Quality Index
...
This Pebble app needs colours, so that's why I only target Emery with one.
